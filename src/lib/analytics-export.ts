/**
 * Analytics Export — Date filtering, CSV export, and PDF report generation.
 *
 * Pure functions: (data) → output. No side effects except download triggers.
 */
...
import type { ClassTrend, ScenarioTrend, StudentTrend } from './session-trends';
...
// ============================================================
// PDF Export (Analytics Summary Report)
// ============================================================
